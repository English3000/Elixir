...
export const pageStyles = StyleSheet.create({
  textInput: { paddingTop: 3, paddingBottom: 4.5, paddingRight: 5, paddingLeft: 7.5,
               borderWidth: 1.7, borderColor: "black" },
...
const custom = StyleSheet.create({
  footer: { position: "absolute", marginTop: height - 45, width,
            alignItems: "center", paddingVertical: 12.5 }
});
